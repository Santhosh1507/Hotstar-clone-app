...
const Viewpopularindocumentary = () => {
  ...
  return (
    <div className=" mx-5 md:mx-24 w-11/12 ">
            <h1 className=" pt-24 pb-10 text-white text-4xl font-bold text-center">Popular in Documentary</h1>
...
export default Viewpopularindocumentary