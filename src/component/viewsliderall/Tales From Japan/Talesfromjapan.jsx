    ...
    return (
        <div className=" mx-5 md:mx-20">
            <div className="flex justify-between mt-14">
                <p className="font-bold text-zinc-300 text-sm sm:text-base md:text-2xl ">Tales From Japan</p>
                <Link to='/home/talesfromjapan' className=" text-slate-500 hover:text-slate-300">View All&gt;&gt;</Link>
            </div>
