...
import Tvsliderpage from './Tvsliderpage/Tvsliderpage'
import Tvstarplusshows from './TvStarPlus Shows/Tvstarplusshows'
...
const Tvmovies = () => {
  ...
  return (
    ...
    // <div className="mt-15 mx-10 md:mx-32">
    //   <div className=" pt-20">
    //     <p className="text-white text-4xl text-center">Tv</p>
    //   </div>
    //   <div className="flex flex-wrap items-center gap-2 md:gap-5 my-3">
    //     {images.map((image, index) => (
    //       <div key={index} className=" w-20 md:w-40 md:hover:scale-125 duration-200">
    //         <img
    //           src={image}
